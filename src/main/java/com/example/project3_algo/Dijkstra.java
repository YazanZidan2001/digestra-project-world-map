            ...
            while (currentNode != null) {
                ...
                if (!adjacentEntry.known) {
                    ...
                    if (newDist < adjacentEntry.distance) {
                        ...
                        HMap<TableEntry, Integer> indexMap = heap.getIndexMap();
                        if (indexMap.containsKey(adjacentEntry)) {
                            heap.UpdateElement(adjacentEntry, adjacentEntry);
                        } else {
                            heap.add(adjacentEntry);
                        }
                    }
                }
